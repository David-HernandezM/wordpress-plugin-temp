...
registerBlockType(metadata.name, {
    ...
    edit: () => {
        ...
        return (
            <div {...blockProps}>
                <button className='vara-login-button'>Register</button>
            </div>
        );
    },
    save: () => {
        return (
            <div {...useBlockProps.save()} className="vara-register-root"></div>
        );
    }
});
...
//     },
//     save: ({ attributes }) => (
//         <div {...useBlockProps.save()} className='vara-login-component.root'>
//             {/* <button
